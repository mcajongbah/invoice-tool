  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative has-focus:border-ring border border-input shadow-xs has-focus:ring-primary has-focus:ring-[1px] rounded-md",
